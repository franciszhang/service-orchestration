package com.frank.service.choreography.demo;
...
public class ServiceChoreographyDemoApplication {

    public static void main(String[] args) {
        SpringApplication.run(ServiceChoreographyDemoApplication.class, args);
    }
    ...
    public Object test(HttpServletRequest request) throws Exception {
        String path = Objects.requireNonNull(ServiceChoreographyDemoApplication.class.getClassLoader().getResource("b.json")).getPath();
    ...
    public Object test1() throws Exception {
        String path = Objects.requireNonNull(ServiceChoreographyDemoApplication.class.getClassLoader().getResource("a.json")).getPath();
        File file = new File(path);
        String jsonStr = FileUtils.readFileToString(file);
//        String param = "{\"org_id\":\"330108-S000189\",\"dept_id\":\"f2c2521762254d7dbdbc4d908430163e\",\"clientId\":\"c4afe29340cb435a921977bb9fc918be\",\"clientSecret\":\"230106df961c448cae53b25021e34e8b\"}";
    ...
    public Object test2() throws Exception {
        String path = Objects.requireNonNull(ServiceChoreographyDemoApplication.class.getClassLoader().getResource("c.json")).getPath();
        File file = new File(path);
        String jsonStr = FileUtils.readFileToString(file);
    ...
    public Object test3() throws Exception {
        String path = Objects.requireNonNull(ServiceChoreographyDemoApplication.class.getClassLoader().getResource("d.json")).getPath();
        File file = new File(path);
        String jsonStr = FileUtils.readFileToString(file);
    ...
    public Object test4() throws Exception {
        String path = Objects.requireNonNull(ServiceChoreographyDemoApplication.class.getClassLoader().getResource("e.json")).getPath();
        File file = new File(path);
        String jsonStr = FileUtils.readFileToString(file);
    ...
    public Object test5() throws Exception {
        String path = Objects.requireNonNull(ServiceChoreographyDemoApplication.class.getClassLoader().getResource("f.json")).getPath();
        File file = new File(path);
        String jsonStr = FileUtils.readFileToString(file);
//        String param = "{\"deptId\":[\"228891204B02461B875CEE137E0EFF8B\"],\"workContext\":{\"orgId\":\"440101-S000011\"}}";
    ...
    public Object test0(HttpServletRequest request) throws Exception {
        ...
        String path = Objects.requireNonNull(ServiceChoreographyDemoApplication.class.getClassLoader().getResource(map.get("file").toString())).getPath();
        File file = new File(path);
        String jsonStr = FileUtils.readFileToString(file);
        Map<String, Object> process = serviceChoreographyFacade.process(jsonStr, JSON.toJSONString(map));
        System.out.println(JSON.toJSONString(process));
